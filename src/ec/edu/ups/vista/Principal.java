...
public class Principal extends javax.swing.JFrame {
    ...
    private CrearP crearpersona;
    private Buscar buscarpersona;
    private Modificar modificarpersona;
    private Eliminar eliminarpersona;
    private Listar listarpersona;
    /**
    ...
    private void saveAsMenuItemActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_saveAsMenuItemActionPerformed
        ...
        if (modificarpersona == null || modificarpersona.isVisible() == false) {
            modificarpersona = new Modificar();
            modificarpersona.setVisible(true);
    ...
    private void jMenuItem1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jMenuItem1ActionPerformed
        // TODO add your handling code here:
       if (listarpersona == null || !listarpersona.isVisible()) {
            listarpersona = new Listar();
            listarpersona.setVisible(true);
            desktopPane.add(listarpersona);
            listarpersona.toFront();
        }
